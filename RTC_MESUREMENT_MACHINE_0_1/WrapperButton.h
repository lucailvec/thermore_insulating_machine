...
class WrapperButton{
  public: WrapperButton(int initialValue, Button *increment, Button *decrement,int min,int max);//un costruttore che consente di inizializzare il valore ad una certa soglia e in più che acquisisca i puntatori dei bottoni da utilizzare
